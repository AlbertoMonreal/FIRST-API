...
let SampleRepository = class SampleRepository {
    ...
    findById(sampleId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const samples = yield this.databaseService.execQuery(queryDoc);
...
exports.SampleRepository = SampleRepository = __decorate([
    (0, typedi_1.Service)(),
